...
class SSOWebViewActivity : BaseActivity<CovActivitySsoBinding>() {
    ...
    companion object {
        ...
        private val ssoUrl: String get() = "${ServerConfig.toolBoxUrl}/v1/convoai/sso/login"
        private val signupUrl: String get() = "${ServerConfig.toolBoxUrl}/v1/convoai/sso/signup"
    ...
    inner class WebAppInterface(private val context: Context) {
        ...
        fun handleResponse(response: String) {
            ...
            if (!response.startsWith("Error")) {
                ...
                runOnUiThread {
                    setResult(RESULT_OK, Intent().putExtra(EXTRA_TOKEN, response))
                    finish()
                }
            } else {
